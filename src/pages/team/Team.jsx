...
import Kshitiz from "./Assets/Mentor/kshitiz.jpg";
...
import Pranav from "./Assets/Coordinator/pranav.JPG";
import "./Team.css";
...
export default function Team() {
  ...
  const council = [Harsh, Samson, Satvik, Divyansh, Nazma, Anant, Pranav];
  const design=[]
  const programming=[]
  const pr=[]
  const operations=[]
